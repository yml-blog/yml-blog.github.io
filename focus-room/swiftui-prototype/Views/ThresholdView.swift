...
struct ThresholdView: View {
    ...
    private var previewAtmosphere: RoomAtmosphere {
        RoomAtmosphere(
            ...
            rainDepth: 0.32 + (viewModel.holdProgress * 0.18),
            skyGlow: 0.42 + (viewModel.holdProgress * 0.12),
            deskReflectionWarmth: 0.10 + (viewModel.holdProgress * 0.22),
            completionSoftness: 0.04,
